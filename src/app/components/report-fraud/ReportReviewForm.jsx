      ...
      <form className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5">
          ...
          <div className="mt-4 space-y-3">
            <ChecklistItem text="The information I provided is accurate." />
            <ChecklistItem text="I removed or hid OTP, PIN, password and private information from evidence." />
            <ChecklistItem text="I understand that moderators will review this report before it becomes public." />
            <ChecklistItem text="I understand false or abusive reports may be removed." />
          </div>
        </div>
...
function ChecklistItem({ text }) {
  return (
    <label className="flex cursor-pointer gap-3 text-sm leading-6 text-slate-600">
      <input type="checkbox" className="mt-1 h-4 w-4 accent-[#009879]" />
      <span>{text}</span>
    </label>
  );
}
